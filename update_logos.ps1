...
foreach ($file in $htmlFiles) {
    ...
    if ($content -match 'assets/images/site_logo/favourite_icon\.svg') {
        ...
        Write-Host "  ℹ️  Favicon kept as original (change manually if needed)" -ForegroundColor Blue
    }
...
Write-Host "  • Header logos updated to: assets/images/KAMAL KATWAL LOGO.svg (180px width)" -ForegroundColor White
Write-Host "  • Footer logos updated to: assets/images/KAMAL KATWAL LOGO.svg (160px width)" -ForegroundColor White
...
Write-Host ""
Write-Host "💡 To run this script again in the future:" -ForegroundColor Yellow
